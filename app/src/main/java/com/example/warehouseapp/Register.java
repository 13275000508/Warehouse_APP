	...
	**/
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(fAuth.getCurrentUser() != null){
            startActivity(new Intent(getApplicationContext(), com.example.warehouseapp.MainMenu.class));
            finish();
        }
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
	        ...
	        **/
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), com.example.warehouseapp.Login.class));
            }
        });
    }
}