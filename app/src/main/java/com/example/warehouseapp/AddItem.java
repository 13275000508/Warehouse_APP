	...
	*/
    ...
    public void clickEnter(View obj)
    {
        ...
        if(name.equals("") || type.equals("") || brand.equals("") || condition.equals("") || quantity.equals("") || price.equals("") || color.equals("") || comments.equals(""))
        {
            ...
            text.setText("Pls enter all fields!");
    ...
    public void chooseType(View obj)
    {
        ...
        Button andriod=findViewById(R.id.android_button);
        Button iphone=findViewById(R.id.iphone_button);
        if(clickedButton.getText().equals("window"))
        {
            type = "window";
            andriod.setBackgroundResource(R.drawable.after_click);
            iphone.setBackgroundResource(R.drawable.round_corner);
        }
        if(clickedButton.getText().equals("mac"))
        {
            type = "mac";
            andriod.setBackgroundResource(R.drawable.round_corner);
            iphone.setBackgroundResource(R.drawable.after_click);
        }
    }
    /**
