...
public class Barcode extends AppCompatActivity {
	...
	**/
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String newName = intent.getStringExtra(com.example.warehouseapp.AddItem.MESSAGE);
        ...
        savingImage.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v)
            {
                ...
                Toast.makeText(Barcode.this, "QR Code save to Photos", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    {
        Intent intent = new Intent(this, com.example.warehouseapp.MainMenu.class);
